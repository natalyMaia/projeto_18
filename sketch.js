...
var knifeImage , knifeSom, gameOver, fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage, knifeSwoosh;
...
function preload(){
  ...
  knifeSom = loadImage("knifeSwoosh.mp3");
  gameOver = loadImage("gameover.mp3");
